    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="text-center space-y-4">
          <h1 className="text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl">CampusKey Fonts</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Official typography for the CampusKey brand identity.
          </p>
        </section>
        ...
        <section className="mt-12">
          <div className="backdrop-blur-sm bg-gradient-to-r from-blue-50/80 to-purple-50/80 dark:from-blue-950/30 dark:to-purple-950/30 rounded-xl p-8 shadow-sm border border-white/20 dark:border-white/5 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Get the complete Gotham font family in a single package, including all weights and styles for consistent
              brand typography.
            </p>
            <Link
