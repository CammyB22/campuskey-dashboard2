...
import { ArrowLeft, CheckCircle, XCircle, Award, ChevronRight, Home, BookOpen } from "lucide-react"
  ...
  const moduleContent = [
    {
      title: "Our Purpose",
      content:
        "CampusKey exists to create transformative living spaces that empower students to thrive academically, socially, and personally. We believe that the right environment is fundamental to success and growth. Our purpose goes beyond providing a place to stay—we create homes where students can belong, grow, and succeed.",
    },
    {
      title: "Our Vision",
      content:
        "To be recognized globally as the leader in innovative student living, setting new standards for community-focused accommodation that nurtures academic excellence and personal development. We envision a world where student accommodation is not just a necessity but a catalyst for growth and transformation.",
    },
    {
      title: "Our Mission",
      content:
        "To create spaces where students can live their best lives and reach their full potential. We accomplish this by designing thoughtful living spaces that balance privacy with community, creating programs that foster academic success and personal growth, building vibrant communities where students feel they belong, embracing innovation in our facilities, services, and experiences, and maintaining the highest standards of safety, comfort, and sustainability.",
    },
    {
      title: "Living the Brand",
      content:
        "At CampusKey, 'Living the Brand' means that every team member embodies our values and purpose in their daily work. It's not just what we say, but what we do that defines us. When we live the brand, we create authentic experiences that resonate with our students and colleagues. This means treating each other with the same care and respect that we show to our students, making decisions that prioritize community and growth, and constantly seeking ways to enhance the student experience.",
    },
  ]
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          >
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-pink-100 to-purple-100 dark:from-pink-950/20 dark:to-purple-950/20 rounded-xl opacity-30"></div>
              <div className="relative p-8 text-center">
                ...
                <div className="grid gap-6 md:grid-cols-3 text-left">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground pl-10">Why CampusKey exists and what drives us</p>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground pl-10">Where we're headed and what we aspire to be</p>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm text-muted-foreground pl-10">How we'll achieve our vision day by day</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-bold">Module Content</h2>
              <p className="text-muted-foreground">
                Learn about the core principles that guide CampusKey's mission and vision.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {moduleContent.map((section, index) => (
                <Card
                  key={index}
                  className="bg-white/80 dark:bg-black/20 backdrop-blur-sm border shadow-sm overflow-hidden"
                >
                  <div
                    className={cn(
                      "h-1.5",
